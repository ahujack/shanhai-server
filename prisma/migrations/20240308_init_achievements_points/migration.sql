-- CreateAchievementsAndPoints
-- This migration creates the achievements and points system tables
...
CREATE INDEX "PointRecord_userId_idx" ON "PointRecord"("userId");
